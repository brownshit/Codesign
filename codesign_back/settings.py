"""
Django settings for codesign_back project.
...
SECRET_KEY = 'django-insecure-g2g9r^b6q_%x0mg=mrmo2y+$-qjc*_+r!+0n5)w9gvo*se2%eg'
...
WSGI_APPLICATION = 'codesign_back.wsgi.application'
...
# 리액트 앱의 URL 설정
FRONTEND_URL = '/co-design/'
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # 간단한 예제를 위해 모든 요청에 대해 접근 허용
    ]
}
